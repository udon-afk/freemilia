@font-face {
  font-family: "lucide";
  src: url('lucide.eot?t=1769165204291'); /* IE9*/
  src: url('lucide.eot?t=1769165204291#iefix') format('embedded-opentype') /* IE6-IE8 */,
  url('lucide.woff2?t=1769165204291') format('woff2'),
  url('lucide.woff?t=1769165204291') format('woff'),
  url('lucide.ttf?t=1769165204291') format('truetype'),
  url('lucide.svg?t=1769165204291') format('svg');
}
...
.icon-globe-x::before { content: "\e6ba"; }
...
.icon-printer-x::before { content: "\e6bb"; }
